                ...
                <Row className="mt-5">
                  <Col xs={12} sm={6} md={6} lg={3} className="mb-4 mb-lg-0">
                    <div className="role-card shadow-sm">
                      ...
                      <h4 style={{ color: '#667eea', fontWeight: 700 }}>Admin</h4>
                  ...
                  <Col xs={12} sm={6} md={6} lg={3} className="mb-4 mb-lg-0">
                    <div className="role-card shadow-sm">
                      ...
                      <h4 style={{ color: '#667eea', fontWeight: 700 }}>Teacher</h4>
                      <p className="text-muted mb-0" style={{ fontSize: '0.9rem' }}>
                  ...
                  <Col xs={12} sm={6} md={6} lg={3} className="mb-4 mb-lg-0">
                    <div className="role-card shadow-sm">
                      ...
                      <h4 style={{ color: '#667eea', fontWeight: 700 }}>Parent</h4>
                      <p className="text-muted mb-0" style={{ fontSize: '0.9rem' }}>
                  ...
                  <Col xs={12} sm={6} md={6} lg={3} className="mb-4 mb-lg-0">
                    <div className="role-card shadow-sm">
                      ...
                      <h4 style={{ color: '#667eea', fontWeight: 700 }}>Student</h4>
                      <p className="text-muted mb-0" style={{ fontSize: '0.9rem' }}>
